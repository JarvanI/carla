...
#include "NewShaderPluginBlueprintLibrary.generated.h"
...
UCLASS(MinimalAPI, meta = (ScriptName = "NewShaderPluginBlueprintLibrary"))
class UNewShaderPluginBlueprintLibrary : public UBlueprintFunctionLibrary
{
