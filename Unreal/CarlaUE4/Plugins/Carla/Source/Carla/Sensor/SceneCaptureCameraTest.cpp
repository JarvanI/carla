...
#include "Carla.h"
#include "Carla/Sensor/SceneCaptureCameraTest.h"

FActorDefinition ASceneCaptureCameraTest::GetSensorDefinition()
{
...
ASceneCaptureCameraTest::ASceneCaptureCameraTest(const FObjectInitializer &ObjectInitializer)
...
void ASceneCaptureCameraTest::Tick(float DeltaTime)
{
...
void ASceneCaptureCameraTest::SendSceneCaptureCameraPixelsInRenderThread(ASceneCaptureCameraTest &Sensor)
{
            ...
            [&Sensor, Stream = this->GetDataStream(Sensor)](auto &InRHICmdList) mutable
    {
        if (!Sensor.IsPendingKill())
        {
            ...
            Sensor.WriteSceneCaptureCameraPixelsToBuffer(
                Buffer,
                carla::sensor::SensorRegistry::get<ASceneCaptureCameraTest *>::type::header_offset,
                Sensor,
                InRHICmdList);
...
void ASceneCaptureCameraTest::WriteSceneCaptureCameraPixelsToBuffer(
    carla::Buffer &Buffer,
    uint32 Offset,
    ASceneCaptureCameraTest &Sensor,
