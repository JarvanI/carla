...
#include "FisheyeCameraMultiCS.generated.h"
 ...
 */
UCLASS()
class CARLA_API AFisheyeCameraMultiCS : public ASensor
{
    GENERATED_BODY()
...
public:
    ...
    AFisheyeCameraMultiCS(const FObjectInitializer &ObjectInitializer);
    ...
    void SendFisheyeCameraMultiCSPixelsInRenderThread(AFisheyeCameraMultiCS &Sensor);

    void WriteFisheyeCameraMultiCSPixelsToBuffer(
        carla::Buffer &Buffer,
        uint32 Offset,
...
public:
    ...
    struct FCameraAttribute *CameraAttributes[5];
    ...
    class UNewShaderRendering* NewShaderRenderingPtr = nullptr;
};