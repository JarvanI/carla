...
void UActorBlueprintFunctionLibrary::AddCommonFisheyeCameraCS4CameraParameters(
    const FString& Id,
...
FActorDefinition UActorBlueprintFunctionLibrary::MakeFisheyeCameraCS4Definition(
    const FString& Id,
    bool bEnableModifyingPostProcessEffects)
{
    FActorDefinition Definition;
    bool Success;
    MakeFisheyeCameraCS4Definition(Id, bEnableModifyingPostProcessEffects, Success, Definition);
    check(Success);
    return Definition;
}


void UActorBlueprintFunctionLibrary::MakeFisheyeCameraCS4Definition(
    const FString& Id,
    bool bEnableModifyingPostProcessEffects,
    bool& Success,
    FActorDefinition& Definition)
{
    ...
    AddVariationsForSensor(Definition);
    AddCommonCameraParameters(Id, bEnableModifyingPostProcessEffects, Success, Definition);
    AddCommonFisheyeCameraCS4CameraParameters(Id, bEnableModifyingPostProcessEffects, Success, Definition);
    if (bEnableModifyingPostProcessEffects)
    {
        AddCommonPostProcessingEffectsParameters(
            Id, bEnableModifyingPostProcessEffects, Success, Definition);
