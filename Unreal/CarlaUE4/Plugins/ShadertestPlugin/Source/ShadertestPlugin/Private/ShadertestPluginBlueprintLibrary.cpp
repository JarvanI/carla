...
#include "ShadertestPluginBlueprintLibrary.h"


#define LOCTEXT_NAMESPACE "UShadertestPluginBlueprintLibrary"  

UShadertestPluginBlueprintLibrary::UShadertestPluginBlueprintLibrary(const FObjectInitializer& ObjectInitializer)
